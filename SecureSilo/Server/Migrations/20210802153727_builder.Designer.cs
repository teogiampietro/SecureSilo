...
namespace SecureSilo.Server.Migrations
{
    ...
    [Migration("20210802153727_builder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SecureSilo.Shared.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SecureSilo.Shared.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SecureSilo.Shared.Parametro", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HumedadMinValue = 16.0,
                            Riesgo = "ALTO",
                            TemperaturaValue = 30.0
                        },
                        new
                        {
                            Id = 2,
                            GranoID = 1,
                            HumedadMaxValue = 16.0,
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SecureSilo.Shared.Identity.ApplicationUser", null)
                        .WithMany()
